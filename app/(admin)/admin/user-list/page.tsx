...
import {
  ...
  SelectContent,
  SelectItem,
} from "@/components/ui/select"; // Adjust the path based on your ShadCN setup
  ...
  const handleDownloadFile = async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_APP_URL}/api/users/download?format=${fileFormat}`
      );
      if (response.ok) {
