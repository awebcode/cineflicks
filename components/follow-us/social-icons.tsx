...
const socialLinks = [
  {
    name: "Facebook",
    icon: (
      <svg viewBox="0 0 24 24" className="w-[51px] h-[60px] fill-current">
    ...
    <div className="flex gap-6 flex-wrap justify-center">
      {socialLinks.map((social) => (
        ...
        >
          <Link
            href={social.href}
            className="w-[92px] h-[92px] flex items-center justify-center rounded-full bg-[#F5A64C] text-white hover:bg-[#E89539] transition-colors"
            target="_blank"
